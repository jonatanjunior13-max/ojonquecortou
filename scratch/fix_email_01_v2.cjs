...
async function run() {
  console.log("Fixing, cleaning, and minimizing email_01.html (Confirmation)...");
  ...
  // 5. Clean style="..." attributes, resolving mismatched quotes
  ...
  console.log(`-> email_01_clean.html created and minimized. Size: ${content.length} bytes.`);
