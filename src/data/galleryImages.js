// Shared between GalleryPage.jsx (client render) and scripts/prerender.js
// (server noscript snapshot) so the crawlable/no-JS version of /galeria
// isn't limited to zero <img> tags while the live gallery shows real photos.
